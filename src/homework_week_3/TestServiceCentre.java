...
public class TestServiceCentre {
    public static void main(String[] args) {
        ...
        Director directorSC1=new Director("Vasya", 1000, "director", null);
        Admin adminSC1= new Admin("Misha",1100, "admin",null);
        RepairExpert repairExpertSC1=new RepairExpert("Kolya",2000,"RepairExpert",null);
        ...
        Director director2SC1=new Director("Sergey", 4000, "director",sc1);
        ...
        Repair repairSC1 = new Repair(repairExpertSC1, printer, "in work");
